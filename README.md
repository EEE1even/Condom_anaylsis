...
![](src\image-20211125225314168.png)
...
在处理完数据之后，我得到了七件商品的追评和搜索后的商品数据，当然这些都是通过结巴分词处理好的文件。![](src\QQ截图20211209205531.png)

当然还有一份商品信息的数据

![](src\QQ截图20211209211408.png)
